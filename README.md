...
5. Launch **Shopping Web Api -> https://localhost:7070** in postman and send api request to internal modules. You can import postman collection in your local environment.
